...
public final class EventConstant
{
    ...
    public static final int SET_STATE_OK = EVENT_BASE + 0x0063;

    public static final int SET_STATE_FAIL = EVENT_BASE + 0x0064;

    public static final int SET_STATE_TIMEOUT = EVENT_BASE + 0x0065;
